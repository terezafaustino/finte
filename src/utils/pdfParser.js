...
const CATEGORY_KEYWORDS = {
  ...
  casa_utensilios:  ['tok stok', 'leroy merlin', 'casas bahia', 'etna', 'ikea', 'shoptime', 'mobly', 'hogar', 'decoração', 'móveis', 'cama mesa', 'utilidades', 'eletrodoméstico'],
  assinaturas: ['netflix', 'spotify', 'deezer', 'amazon prime', 'hbo', 'disney', 'apple', 'google one', 'youtube', 'globoplay', 'star+', 'paramount', 'mubi', 'duolingo', 'adobe', 'microsoft', 'dropbox', 'notion', 'figma', 'chatgpt', 'openai', 'crunchyroll', 'linkedin premium'],
